...
function atualizaInterface() {
    ...
    if (candidato.length > 0) {
        ...
        // Constrói a descrição do candidato
        let descricaoHtml = `Nome: ${candidato.nome}<br/>Partido: ${candidato.partido}`;
        if (candidato.vice) {
            descricaoHtml += `<br/>Vice: ${candidato.vice}`;
        }
        descricao.innerHTML = descricaoHtml; // Exibe detalhes do candidato
